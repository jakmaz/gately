...
---
import { MiniPreview } from "../../components/home/mini-preview";
...
<div className="my-10 h-[450px] w-full rounded-2xl overflow-hidden border border-border shadow-2xl relative">
  <MiniPreview client:load />
</div>
